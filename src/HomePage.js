        ...
        {filteredProducts.map((product) => (
          <div key={product.id} className="col-md-3 mb-4">
            <div className="card" style={{ width: '10rem' }}>
              <img src={product.imageUrl} style={{ width: '100%', height: '12rem', objectFit: 'scale-down', borderRadius:"10px", objectFit: 'cover' }} className="card-img-top card-images" alt={product.title} />
